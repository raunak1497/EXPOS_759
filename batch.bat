...
load --exec $HOME/myexpos/expl/Samples/assg24.xsm
load --exec $HOME/myexpos/expl/Samples/assg24_2.xsm
...
load --int=13 ../spl/int13.xsm
load --int=14 ../spl/int14.xsm
...
load --module 3 $HOME/myexpos/spl/mod3.xsm
